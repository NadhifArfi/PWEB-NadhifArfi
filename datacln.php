...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Calon</h1>
                        <a href="input_calon.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tambah Data Calon</a>
                    </div>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysqli_query($user,"SELECT *FROM calon")or die(mysql_error());
		$nomor = 1;
		...
		<tr>
			...
			<td>
				<a class="edit" href="edit_calon.php?id=<?php echo $data['ID']; ?>">Edit</a> |
				<a class="hapus" href="hapus_calon.php?id=<?php echo $data['ID']; ?>">Hapus</a>	
			</td>
		</tr>
		<?php } ?>
	</table>
