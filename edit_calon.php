...
<body id="page-top">
	...
	<a href="datacln.php">Lihat Semua Data</a>
	...
	include "koneksi.php";
	$ID = $_GET['id'];
	$query_mysql = mysqli_query($user,"SELECT * FROM calon WHERE id='$ID'")or die(mysql_error());
	$nomor = 1;
	while($data = mysqli_fetch_array($query_mysql)){
	?>
	<form action="update_calon.php" method="post">		
		<table>
			<tr>
				<td>Nama</td>
				<td>
			...
			<tr>
				<td>NIM</td>
				<td><input type="text" name="Sebagai" value="<?php echo $data['Sebagai'] ?>"></td>					
			</tr>	
			<tr>
				<td>Jurusan</td>
				<td><input type="text" name="Organisasi" value="<?php echo $data['Organisasi'] ?>"></td>					
			</tr>		
			<tr>
				<td></td>
